				...
				<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
					<div className="bg-white rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
						<div className="sticky top-0 bg-white border-b px-6 py-4 flex items-center justify-between">
							<div>
								<h2 className="text-2xl font-bold text-gray-900">All Features & Modules</h2>
								<p className="text-gray-600 text-sm mt-1">Quick access to all HRMS features</p>
							</div>
							<button
						...
						<div className="p-6 grid grid-cols-2 sm:grid-cols-3 gap-4">
							{modules.map((module) => (
								...
								>
									<div className={`${module.color} w-12 h-12 rounded-lg flex items-center justify-center text-xl mb-3`}>
										{module.icon}
									</div>
